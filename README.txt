s01t05n01 Llopart Gil Ismael


Exercici 1:

java -jar exercici-1.jar list <ruta del sistema> (Llista directori especificat )

Exercici 2:

java -jar exercici-2.jar list <ruta del sistema> (Llista directori especificat en arbre)

Exercici 3:

java -jar exercici-3.jar list <ruta del sistema> (Llista directori especificat en arbre)

java -jar exercici-3.jar savelist <ruta del sistema> (Llista directori especificat en arbre i el desa a Llistats.txt)

Exercici 4 i 5: (Vaig escriure el cinquè damunt del quart)

java -jar exercici-4.jar list <ruta del sistema> (Llista directori especificat en arbre)

java -jar exercici-4.jar savelist <ruta del sistema> (Llista directori especificat en arbre i el desa a Llistats.txt)

java -jar exercici-4 llegir <ruta del sistema> (llegeix un fitxer especificat i el mostra per pantalla)
